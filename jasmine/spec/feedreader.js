    ...
    */
    ...
    describe('Initial Entries', function() {
        ...
        it('are well loaded on page', function () {
            //Saving all the ".entry" elements present on ".feed" element
            var entriesOnDotFeed = $('.feed').children('.entry-link').children('.entry');
            //Checking if there's at least one element
            expect(entriesOnDotFeed.length).toBeGreaterThan(0);
        });
    });
